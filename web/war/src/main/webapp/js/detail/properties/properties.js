                    ...
                    .each(function() {
                        ...
                        if (displayType && F.vertex.properties[displayType]) {
                            ...
                            if (textContent !== truncatedTextContent) {
                                ...
                                $('<span/>').addClass('value-expand twizzle')
                                    .text(i18n('properties.value.expand'))
                                    .appendTo($valueSpan)
                                    .toggleClass('twizzle-expand', truncatedValueCache[property.key].expanded)
                                    .on('click', function(e) {
                                        ...
                                        $(this)
                                            .text(shouldExpand ? i18n('properties.value.collapse') : i18n('properties.value.expand'))
                                            .toggleClass('twizzle-expand', shouldExpand);
